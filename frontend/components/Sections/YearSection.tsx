...
export default function YearSection({ yearData }: YearSectionProps) {
  return (
    <section id={`year-${yearData.year}`} className="mb-10 md:mb-12">
      {/* Divisore anno */}
      <div className="border-t-4 border-aba-red pt-3 md:pt-4 mb-6 md:mb-8">
        <h2 className="text-2xl md:text-4xl font-poppins font-bold text-gray-dark">
          {yearData.year}
        </h2>
        <p className="text-gray-600 font-inter mt-1 text-sm md:text-base">
